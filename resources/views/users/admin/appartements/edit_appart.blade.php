          ...
          <div class="col-sm-3"></div>
            <div class="col-sm-6">
              <div class="card shadow rounded rounded-3">
                  <div class="card-body">
                      <form class="form-horizontal form-material" action="{{URL::to('update-appart/'.$edit->id)}}" method="post">
                          @csrf
                          <div class="form-group mb-4">
                              <label class="col-md-12 p-0">Type d'appartement</label>
                              <div class="col-md-12 border-bottom p-0">
                                  <input type="text" placeholder="exemple : 3 pièces" value="{{$edit->AppName}}"
                                      class="form-control p-0 border-0" name="appname" id="appname">
                              </div>
                          </div>
                          <div class="form-group mb-4">
                              <label for="example-email" class="col-md-12 p-0">La somme de l'appartement</label>
                              <div class="col-md-12 border-bottom p-0">
                                  <input type="number" placeholder="100000" value="{{$edit->AppPrice}}"
