                            ...
                            <tbody>
                              @foreach($all as $key=>$row)
                                <tr>
                                    ...
                                    <td>
                                      <a href="{{URL::to('/modifier-appart/'.$row->id)}}" class="font-18 bg-info text-white p-2 rounded-3 shadow-sm m-r-30">
                                        <i class="fas fa-edit"></i>
                                      </a>
                                      <a href="{{URL::to('/delete-appart/'.$row->id)}}" class="font-18 bg-danger text-white p-2 rounded-3 shadow-sm">
